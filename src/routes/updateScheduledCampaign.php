...
$app->post('/api/SendGrid/updateScheduledCampaign', function ($request, $response, $args) {
    ...
    $resp = $sg->client->campaigns()->_($campaign_id)->schedules()->patch($request_body);
    $body = $resp->body();
