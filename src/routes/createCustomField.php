...
$app->post('/api/SendGrid/createCustomField', function ($request, $response, $args) {
    ...
    $request_body['type'] = $post_data['args']['type'];
    
    $sg = new \SendGrid($apiKey);
    
    try {
        $resp = $sg->client->contactdb()->custom_fields()->post($request_body);
        $body = $resp->body();
